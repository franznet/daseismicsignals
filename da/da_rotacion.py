...
class FLAG_DA:
  ...
  iPorcentajeTiempoFinal  = 6             # Signal time percentage for end rotation. Range 0-100.
  iPorcentajeTiempoInc    = 5             # Increment
  iPorcentajeTiempoLong   = 20            # Length of percentage ranges.
...
def generaMasivo():
  ...
  for i in range(FLAG_DA.iPorcentajeTiempoInicio, FLAG_DA.iPorcentajeTiempoFinal+1, FLAG_DA.iPorcentajeTiempoInc):
    ...
    generarEventoTiempoRangoAleatorio(FLAG_DA.sRutaEntrada, FLAG_DA.sRutaSalida, {'HY':13419, 'LP':13419, 'TC':13419 ,'TR':13419, 'VT':13419}, i, i+FLAG_DA.iPorcentajeTiempoLong)
    #generarEventoTiempoRangoAleatorio(FLAG_DA.sRutaEntrada, FLAG_DA.sRutaSalida, {'LP':13419, 'TC':13419 ,'TR':13419, 'VT':13419}, i, i+FLAG_DA.iPorcentajeTiempoLong)
    # Add original spectrograms without noise cut
    print("Copy original spectrograms:")
    #call(r'xcopy /s /q "D:\UCN\Python\escenario2\spectrograms224_00 210708" E:\spectrograms224_00')
    # Compress folder
    print("Compress to ZIP:")
    call(r'C:\Program Files\7-Zip\7z.exe a -tzip E:\spectrograms224_00'+'.'+str(i).zfill(2)+'-'+str(i+FLAG_DA.iPorcentajeTiempoLong).zfill(2)+'.zip E:\spectrograms224_00')
    # Move file to Google Drive
    print('Move to Google Drive:' +'spectrograms224_00'+'.'+str(i).zfill(2)+'-'+str(i+FLAG_DA.iPorcentajeTiempoLong).zfill(2)+'.zip')
    call(r'move "E:\spectrograms224_00'+'.'+str(i).zfill(2)+'-'+str(i+FLAG_DA.iPorcentajeTiempoLong).zfill(2)+r'.zip" "D:\Google Drive\Espectrogramas\Escenario2\00\spectrograms224_00 +daRotacion4"', shell=True)
    # Remove generated spectrogram folder
    print(r"Remove generated spectrogram folder: E:\spectrograms224_00")
    call(r'rmdir /q /s E:\spectrograms224_00', shell=True)
  print("End   :", fym.now_string())

# Generating random event list to create DATASETS
#print("Start:", fym.now_string())
#dResultado=generarEventoDiccionario(FLAG_DA.sRutaEntrada, FLAG_DA.lEvento, iCantidad={'HY':2000, 'LP':1500, 'TR':1800, 'VT':1350})
#guarda_lista('eventos.pkl', dResultado)
#dResultado=lee_lista('eventos.pkl')
#print("End   :", fym.now_string())
#print(len(dResultado['VT']))

# Generating percentage ranges on disk
#print("Start:", fym.now_string())
#generarEventoTiempoRango('escenario2/data/', 'escenario2/data_augmentation_rotacion+/', ['HY','LP','TC','TR','VT'], 3, 4)
#print("End:", fym.now_string())
...
generarEventoTiempoRangoAleatorio(FLAG_DA.sRutaEntrada, 'escenario2/spectrograms224_00 210708 20Hz+da_rotacion 67095/', {'HY':13419, 'LP':13419, 'TC':13419 ,'TR':13419, 'VT':13419}, 5, 25)
print("End  :", fym.now_string())
