...
RUTA_SALIDA     ='escenario2/01/data_augmentation_specaugment/'
...
generarEvento(RUTA_ENTRADA, RUTA_SALIDA, EVENTO_ESTUDIO, iCantidad=2686, fFrecuenciaPorcentaje=0.15, iFrecuenciaCantidad=2, fTiempoPorcentaje=0.15, iTiempoCantidad=2)
